...
Adds a SystemD timer that updates the AACS KYDB file for playing bluray disks. By default it runs on Friday at 8pm, but it is possible to edit the Timer file to change to a better day.
